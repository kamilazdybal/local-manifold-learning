...
![Screenshot](clusters-animation-BS-VQPCA-idx0mf-scaling-auto-q1-k8.gif)

#### Random initialization

The observations in clusters get re-distributed in an iterative process from the initial randomly generated clusters:

![Screenshot](clusters-animation-BS-VQPCA-idx0random-random-seed-200-scaling-auto-q1-k8.gif)
...
![Screenshot](clusters-animation-BS-VQPCA-idx0mf-scaling-pareto-q1-k8.gif)

#### Random initialization

The observations in clusters get re-distributed in an iterative process from the initial randomly generated clusters:

![Screenshot](clusters-animation-BS-VQPCA-idx0random-random-seed-200-scaling-pareto-q1-k8.gif)
